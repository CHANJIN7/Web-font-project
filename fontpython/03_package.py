...
parser.add_argument('--dir',            dest='dir',         default='/home/dev/fontpython/data/pair', help='path of examples')
parser.add_argument('--save_dir',       dest='save_dir',    default='/home/dev/fontpython/data/package', help='path to save pickled files')
