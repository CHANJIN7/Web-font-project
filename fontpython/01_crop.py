...
parser.add_argument('--src_dir',        dest='src_dir',  help='directory to read scanned images',     default='/home/dev/fontpython/data/client_template')
parser.add_argument('--dst_dir',        dest='dst_dir',  help='directory to save character images',   default='/home/dev/fontpython/data')
parser.add_argument('--unicode_txt',    dest='unicode_txt', help='unicode text file',                 default='/home/dev/fontpython/data')
