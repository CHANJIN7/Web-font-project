...
parser.add_argument('--sample_dir',         dest='sample_dir',                  default='/home/dev/fontpython/data/pair', help='directory to save examples')
parser.add_argument('--handwriting_dir',    dest='handwriting_dir', type=str,   default='/home/dev/fontpython/data/handwriting',
